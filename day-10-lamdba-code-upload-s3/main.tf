...
resource "aws_s3_bucket" "lambda_bucket" {
  bucket        = "manasa-lambda-bucket"
  acl           = "private"
  force_destroy = true

  tags = {
    Name = "manasaaaLambdaBucket"
  }
}
...
resource "aws_lambda_function" "my_lambda" {
  function_name    = "my_lambda-to-s3"
  runtime          = "python3.9"
  role             = "arn:aws:iam::342547628707:role/lam-dynamo"
